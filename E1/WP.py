...
if __name__ == "__main__":
    ...
    root_path = 'WP/'+ dataset+'_'+model_style+'_epochs'+str(epochs)
    ...
    for rate in pruning_rates:
        ...
        pruned_model = prune_model(model, rate, root_path + f'/model/pruned_model_{rate}.pth')
    ...
    prune_ratios = [0.4,0.5,0.6]  
    prue_model = getmodel(dataset, model_style)

    for ratio in prune_ratios:
        model_path = f'{root_path}/model/pruned_model_{ratio:.1f}.pth'
        ...
        compare_path = root_path + '/compare'+'/'+str(round(ratio,1))
